...
window.Typekit.config = {
  ...
  c: [
    ".tk-sharktooth",
    '"sharktooth",sans-serif',
    ".tk-cubano",
    '"cubano",sans-serif',
    ".tk-cubano-sharp",
    '"cubano-sharp",sans-serif',
    ".tk-aktiv-grotesk",
    '"aktiv-grotesk",sans-serif',
    ".tk-bee",
    '"bee",sans-serif',
    ".tk-base-mono-narrow",
    '"base-mono-narrow",monospace',
    ".tk-rig-solid-bold-fill",
    '"rig-solid-bold-fill",sans-serif',
    ".tk-rig-solid-bold-reverse",
    '"rig-solid-bold-reverse",sans-serif',
    ".tk-rig-solid-medium-fill",
    '"rig-solid-medium-fill",sans-serif',
    ".tk-baskerville-display-pt",
    '"baskerville-display-pt",serif',
    ".tk-baskerville-poster-pt",
    '"baskerville-poster-pt",serif',
    ".tk-marvin",
    '"marvin",sans-serif',
    ".tk-marvin-round",
    '"marvin-round",sans-serif',
    ".tk-marvin-shadow",
    '"marvin-shadow",sans-serif',
  ],
  fi: [
    602, 603, 15488, 15493, 15494, 15495, 14032, 14033, 14034, 14035, 14036,
    21510, 21512, 21514, 25735, 25736, 25737, 25738, 28264, 28265, 28267, 28268,
    37921, 37926, 37929, 39817, 39820, 43322, 43323, 43324,
  ],
  fc: [
    {
      id: 602,
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2020-08-20 17:28:22 UTC"}*/
